...
public class Well extends VillageSComponent
    {
        ...
        public Well(AlterniaVillageStart start, int type, Random rand, int x, int z)
        {
            super(start, type);
        ...
        {
        	AlterniaVillageComponent.generateAndAddRoadPiece((AlterniaVillageStart)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
        	AlterniaVillageComponent.generateAndAddRoadPiece((AlterniaVillageStart)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
        	AlterniaVillageComponent.generateAndAddRoadPiece((AlterniaVillageStart)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
        	AlterniaVillageComponent.generateAndAddRoadPiece((AlterniaVillageStart)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
        }
